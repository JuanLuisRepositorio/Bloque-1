...
for i in range(0, len(listado_frutas_mercado)):
  if 
    print("Sí la tenemos, puedes adquirirla en nuestra sección de frutas frescas...")
  else:
    count = count + 1  

if 
  print("Esta fruta no esta!! Busca otro supermercado...")
